...
COMPRESSED  ?= YES
ICON        ?= iconc.png
DESCRIPTION ?= "symbolic3 implementation for TI-84 calculators"
...
CSOURCES := $(wildcard src/*.c) $(wildcard src/symbolic4/src/*.c)
USERHEADERS   := $(wildcard src/*.h) $(wildcard src/symbolic4/src/*.h)
